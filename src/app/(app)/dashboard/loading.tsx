export default function Loading() {
  return (
    <div className="p-4 space-y-5">
      ...
      <div className="border border-border bg-surface rounded-sm h-24 animate-pulse" />
      <div className="grid grid-cols-2 gap-3">
        <div className="border border-border bg-surface rounded-sm h-28 animate-pulse" />
        <div className="border border-border bg-surface rounded-sm h-28 animate-pulse" />
      </div>
