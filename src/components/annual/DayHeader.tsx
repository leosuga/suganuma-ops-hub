...
export function DayHeader({ maxDays, dayWidth }: DayHeaderProps) {
  ...
  return (
    <div className="flex-none flex border-b border-border/50 bg-surface/30 sticky top-0 z-30">
        ...
        {Array.from({ length: maxDays }, (_, i) => {
          ...
          return (
            <div
              key={day}
              className={cn(
                "flex-none flex items-center justify-center border-r border-border/20 text-[8px] font-mono tabular-nums",
                isToday
